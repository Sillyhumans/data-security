...
public:
	...
	// int32 seckyid = 2;
	void clear_seckyid();
	static const int kSeckyidFieldNumber = 2;
	::PROTOBUF_NAMESPACE_ID::int32 seckyid() const;
	void set_seckyid(::PROTOBUF_NAMESPACE_ID::int32 value);
...
private:
	...
	bool rv_;
	::PROTOBUF_NAMESPACE_ID::int32 seckyid_;
...
// int32 seckyid = 2;
inline void RespondMsg::clear_seckyid() {
	seckyid_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 RespondMsg::seckyid() const {
	// @@protoc_insertion_point(field_get:RespondMsg.seckyid)
	return seckyid_;
}
inline void RespondMsg::set_seckyid(::PROTOBUF_NAMESPACE_ID::int32 value) {

	seckyid_ = value;
	// @@protoc_insertion_point(field_set:RespondMsg.seckyid)
}
